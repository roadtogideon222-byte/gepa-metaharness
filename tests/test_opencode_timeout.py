...
from metaharness.proposer.opencode_run import OpenCodeRunBackend
...
class OpenCodeTimeoutTests(unittest.TestCase):
    def test_opencode_backend_timeout_marks_candidate_failed(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = optimize_harness(
                baseline=baseline,
                proposer=OpenCodeRunBackend(opencode_binary=str(fake_opencode), timeout_seconds=0.1),
